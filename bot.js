...
var config = {
  events: [
    ...
    {type: "GUILD_ROLE_CREATE", logType: "ROLE_CREATE", limit: 10, delay: 5000},
    {type: "GUILD_ROLE_DELETE", logType: "ROLE_DELETE", limit: 10, delay: 5000},
  ]
}
...
client.on("guildMemberAdd", member => {
  client.channels.find('id', '603863358621614080').send(` **Welcome To __Te__st Server**  `)
}); 
/////////
client.login('NjA1ODE2NDc5NDI1NzU3MTkw.XUFIAQ.XlTgEJknnXrvNRy0Knx-VA7hdwk');
